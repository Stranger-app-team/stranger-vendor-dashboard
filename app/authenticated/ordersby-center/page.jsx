        ...
        <div className="col-span-2 bg-white border text-black border-slate-200 rounded-lg p-6">
          {selectedCentre ? (
            <>
              ...
              {ordersLoading ? (
              ...
              ) : orders.filter(order => ['Accepted', 'Delivered', 'Out for Delivery'].includes(order.status)).length > 0 ? (
                <div className="overflow-x-auto">
                  <table className="min-w-[700px] w-full text-xs text-left text-gray-700">
                    ...
                    <tbody>
                      {orders
                        .filter(order =>
                          ['Accepted', 'Delivered', 'Out for Delivery'].includes(order.status)
                        )
                        .map((order) => {
                ...
                <p className="text-sm text-slate-500">No matching orders found for this center.</p>
              )}
            </>
          ) : (
